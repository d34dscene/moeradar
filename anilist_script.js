...
function createElement() {
  ...
  var aniElement = document.querySelector('div[class="actions"]');
  var text;
  button.setAttribute(
    "style",
    "display: inline-block;text-align: center;vertical-align: middle;border: 1px solid;padding: 0.375rem 0.75rem;font-size: 1.5rem;border-radius: 0.5rem;"
  );

  if (type == "TV") {
    text = document.createTextNode("Send to Sonarr");
    button.appendChild(text);
    aniElement.appendChild(button);
